...
class NewGroupsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.unSubscribedGroupName.text = unSubscribedGroup.groupName
        cell?.unSubscribedGroupPicture.image = UIImage(named: unSubscribedGroup.groupPicture)
    ...
    override func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let subscribeAction = UISwipeActionsConfiguration(actions: [UIContextualAction(style: .normal,
                                                                                       title: "Subscribe",
